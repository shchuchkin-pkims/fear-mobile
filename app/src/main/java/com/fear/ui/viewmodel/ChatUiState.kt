...
data class ConnectFormState(
    /* Сервер по умолчанию - Меппел, независимо от того, каким по счёту он
     * стоит в списке (там первой идёт Москва). Запомненный выбор человека
     * важнее и подставляется поверх этого значения при запуске. */
